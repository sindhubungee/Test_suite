...
async function outOfStockPage(){
  ...
  page=await brandSummary.loadBrandSummaryPage();
      ...
      await page.waitForSelector('.margin-top-55 > .detail-selection > .col-xl-4:nth-child(3) > .selection-box > .view')
      await page.click('.margin-top-55 > .detail-selection > .col-xl-4:nth-child(3) > .selection-box > .view')
      await sleep(3000)
      let openFlag= await page.evaluate(()=>{
      ...
      //back button to get back to summary page
