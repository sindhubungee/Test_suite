...
async function outOfStockNAlarms(){
...
await page.waitForSelector('.margin-top-55 > .detail-selection:nth-child(6) > .simple-action-card:nth-child(3) > .hover > .event-on-text')
await page.click('.margin-top-55 > .detail-selection:nth-child(6) > .simple-action-card:nth-child(3) > .hover > .event-on-text')
